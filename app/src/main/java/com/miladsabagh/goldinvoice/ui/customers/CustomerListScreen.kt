    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = onAddCustomer) {
                Icon(Icons.Filled.Add, contentDescription = stringResource(R.string.customer_add_title))
            }
        }
    ) { padding ->
        Column(modifier = Modifier
            ...
            if (customers.isEmpty()) {
                EmptyState(message = stringResource(R.string.customers_empty))
            } else {
                LazyColumn(
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(text = customer.fullName, style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.SemiBold)
                if (customer.phone.isNotBlank()) {
                    Text(
                        text = customer.phone.toPersianDigits(),
